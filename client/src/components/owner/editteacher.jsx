...
import {updateTeacher, teacherDetail} from '../../actions/ownerActions'
      ...
      <div class="row">
                  ...
                  <div class="card">
                                   ...
                                   <div className='row'>
                                     ...
                                     <div className='col'>
                                     <button onClick={this.handleRemove} type="button" class="btn btn-outline-danger btn-sm btn-block">
