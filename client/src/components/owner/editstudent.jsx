...
import {updateStudent, studentDetail, deleteStudent, studentBillDetail, getClassBill, updateStudentBill, deleteStudentBill} from '../../actions/ownerActions'
                  ...
                  <div class="card">
                                   ...
                                   <div class="card-body card-block">
                                           ...
                                           <div class="row form-group">
                                               ...
                                               <div class="col-12 col-md-9">
                                                   <select name="clas" onChange={this.handlePromotion} value={this.state.clas} id="SelectLm" class="form-control-sm form-control">
                                   ...
                                   <div className='row'>
                                     ...
                                     <div className='col'>
                                     <button onClick={this.handleRemoval} type="button" class="btn btn-outline-danger btn-sm btn-block">
