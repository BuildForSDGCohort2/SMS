...
import {studentBillDetail, updateStudentBill, studentDetail} from '../../actions/ownerActions'
                              ...
                              <aside class="profile-nav alt">
                                  <section class="card">
                                      ...
                                      <ul class="list-group list-group-flush">
                                        ...
                                        {
                                          (this.state.status)?(
                                            <div className='alert alert-info'>{this.state.name} has balanced {student.gender==='Male'?'his':'her'} school fees <Link to='/debtors'>Go back to Debtors Page</Link></div>
                                          ):(
...
export default connect(mapStateToProps, {studentBillDetail, updateStudentBill, studentDetail})(Debtor)
