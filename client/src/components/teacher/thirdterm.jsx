...
import {thirdTerm,studentDetail,addResult,deleteResult} from '../../actions/teacherActions'
...
export default connect(mapStateToProps, {thirdTerm,studentDetail,addResult,deleteResult})(ThirdTerm);
