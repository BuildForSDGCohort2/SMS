...
import {secondTerm,studentDetail,addResult,deleteResult} from '../../actions/teacherActions'
...
export default connect(mapStateToProps, {secondTerm,studentDetail,addResult,deleteResult})(SecondTerm);
