...
import {firstTerm,studentDetail,addResult,deleteResult} from '../../actions/teacherActions'
...
export default connect(mapStateToProps, {firstTerm,studentDetail,addResult,deleteResult})(FirstTerm);
